import { DefaultCrudRepository, HasManyRepositoryFactory, Filter, Options, repository, HasOneRepositoryFactory, BelongsToAccessor } from '@loopback/repository';
...
export class TodoRepository extends DefaultCrudRepository<
  ...
  constructor(
    ...
    this.todoList = this.createBelongsToAccessorFor('todoList',
